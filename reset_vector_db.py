...
print("📝 STEP 3: CREATING FRESH TEST DATA")
print("-" * 80)
...
print(f"  * Backup created: {backup_dir}/{timestamp if Path('qdrant_storage').exists() else 'N/A'}")
print(f"  * Database cleared and recreated")
print(f"  * Test data ingested: {len(hiring_posts)} documents")
print(f"  * Collection: {collection_name}")
print()
print("[NEXT] Next steps:")
print("  1. The server can now be started with fresh data")
print("  2. To ingest Reddit data (requires credentials): python ingest_reddit_simple.py")
